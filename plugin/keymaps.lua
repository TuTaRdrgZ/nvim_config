...
map("n", "<C-j>", "<cmd> TmuxNavigateRight<CR>", { desc = "Go to Lower Window", remap = true })
map("n", "<C-k>", "<cmd> TmuxNavigateDown<CR>", { desc = "Go to Upper Window", remap = true })
map("n", "<C-l>", "<cmd> TmuxNavigateUp<CR>", { desc = "Go to Right Window", remap = true })
